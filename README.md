...
The card presents the loaded beer as a graphical keg. The beer level drops with the estimated keg remaining sensor, while current and target temperatures are shown directly on the keg.
...
- Graphical keg level based on `Keg Remaining`
- Current and target temperature displayed as part of the keg
